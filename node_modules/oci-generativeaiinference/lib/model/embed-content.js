...
(function (EmbedContent) {
    function getJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "TEXT":
                    return model.EmbedTextContent.getJsonObj(jsonObj, true);
                case "IMAGE":
                    return model.EmbedImageContent.getJsonObj(jsonObj, true);
                default:
    ...
    EmbedContent.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "TEXT":
                    return model.EmbedTextContent.getDeserializedJsonObj(jsonObj, true);
                case "IMAGE":
                    return model.EmbedImageContent.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    EmbedContent.getDeserializedJsonObj = getDeserializedJsonObj;
})(EmbedContent = exports.EmbedContent || (exports.EmbedContent = {}));
