...
export declare namespace EmbedTextContent {
    function getJsonObj(obj: EmbedTextContent, isParentJsonObj?: boolean): object;
    const type = "TEXT";
    function getDeserializedJsonObj(obj: EmbedTextContent, isParentJsonObj?: boolean): object;
}
