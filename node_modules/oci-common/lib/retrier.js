            ...
            while (true) {
                try {
                    ...
                    if (response.status && response.status >= 200 && response.status <= 299) {
                        ...
                        const errorObject = new error_1.OciError(circuitBreakerError.code, "unknown code", circuitBreakerError.message, "unknown", targetService, operationName, timestamp.toISOString(), endpoint, apiReferenceLink);
                ...
                attempt += 1;
                if (this.logger) {
                    lastKnownError instanceof error_1.OciError
